...
```
path/to/vaultc-x86_64-pc-windows-msvc-v0.13.0.exe --help; 
```

To see usage instructions:

```
A tool for unpacking Fields of Mistria `.sav` files. You can pack and unpack saves as needed. Made by Jonathan Spira and NPC Studio. Note: no warranty is given, use at your own risk
...
```
path/to/vaultc-x86_64-pc-windows-msvc-v0.13.0.exe pack --help;
path/to/vaultc-x86_64-pc-windows-msvc-v0.13.0.exe unpack --help;
```
